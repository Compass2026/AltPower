        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="px-6 py-8 flex flex-col gap-6">
                ...
                <div key={item.name} className="flex flex-col gap-4">
                  ...
                  {item.dropdown ? (
                    <div className="grid grid-cols-1 gap-3 pl-4">
                      {item.dropdown.map((sub) => (
                        <Link
                          ...
                          className="text-[19px] font-bold uppercase tracking-widest text-white/60 hover:text-white py-1"
                        >
                          {sub.name}
                        </Link>
                      ))}
                    ...
                    <a
                      href={item.href}
                      onClick={() => setIsMobileMenuOpen(false)}
                      className="text-[19px] font-bold uppercase tracking-widest text-white/60 hover:text-white pl-4 py-1"
                    >
                      View Page
                    </a>
                  )}
              ...
              <a
                href="tel:+16364977314"
                className="flex items-center gap-3 text-[19px] font-black uppercase tracking-widest text-white/80 pt-4 border-t border-white/10"
              >
